      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('user/Login/paidrent'); ?>">
            <i class="fas fa-fw fa-user"></i>
            <span>Payments</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('user/Login/getcommunication'); ?>">
            <i class="fas fa-fw fa-user"></i>
            <span>Communication</span></a>
        </li>
           <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('user/Login/complaint'); ?>">
            <i class="fas fa-fw fa-user"></i>
