...
?>                    
                    <tr>
                      ...
                      <td><?php echo  anchor("admin/Manage_complaint/getcomplaintdetail/{$row->complaint_id}",' ','class="fa fa-edit"')?>
                        <?php echo  anchor("admin/Manage_complaint/deletecomplaint/{$row->complaint_id}",' ','class="fa fa-trash"')?>
